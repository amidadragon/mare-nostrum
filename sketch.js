...
function expandIsland() {
  ...
  if (lvl === 2) {
    ...
    addFloatingText(width / 2, height * 0.3, 'Well dug — fresh water for all!', '#66aaff');
    ...
    if (lvl === 13) {
      ...
      addFloatingText(width / 2, height * 0.3, 'Watchtower stands sentinel!', '#cc8844');
    ...
    if (lvl === 17) {
      // Library — large temple-type building north
