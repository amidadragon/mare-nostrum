# Mare Nostrum — Cozy Roman Odyssey (cozy-forward hybrid)

## ⚠️ WORKFLOW — read this first (decided 2026-05-31)
...
- **Direction:** cozy life-sim is the core; conquest is an optional light voyage. See `OVERHAUL_PLAN.md`.
