# Mare Nostrum / Sunlit Isles — CEO Memory Index

## Project
- [project_game_identity.md](project_game_identity.md) — Game identity, emotional core, vision statement
- [project_architecture.md](project_architecture.md) — Technical architecture, file structure, known issues
- [project_scope.md](project_scope.md) — What's built, what's stub, what's cut
